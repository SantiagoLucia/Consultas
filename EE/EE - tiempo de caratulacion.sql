SELECT 
    ...
    ROUND(SUM(TRUNC(ee.fecha_modificacion) - TRUNC(ee.fecha_creacion))) AS CANTIDAD_DIAS,
    ROUND(AVG(TRUNC(ee.fecha_modificacion) - TRUNC(ee.fecha_creacion))) AS PROMEDIO_DIAS
