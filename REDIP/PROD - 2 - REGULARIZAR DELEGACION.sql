...
BEGIN
	...
	SELECT COUNT(*) INTO v_numero_esperado FROM RCE_GED.RCE_ACTA_REGISTRO WHERE 
		CIRCUNSCRIPCION = 'La Plata 3301';
...
-- bloque update
	...
	UPDATE RCE_GED.RCE_ACTA_REGISTRO SET CIRCUNSCRIPCION = 'Servicio Penitenciario y Patronato 3301'
		WHERE CIRCUNSCRIPCION = 'La Plata 3301';
