...
left join ee_ged.ee_expediente_electronico ee on h.id_expediente = ee.id
...
left join track_ged.sade_reparticion sr3 on h.codigo_jurisdiccion_origen = sr3.codigo_reparticion
left join track_ged.sade_reparticion sr4 on h.codigo_jurisdiccion_destino = sr4.codigo_reparticion
...
and (
(h.reparticion_usuario = 'DPPSGG' and h.sector_usuario_origen = 'MAYS'
    and h.codigo_sector_destino != 'MAYS') or
(h.codigo_reparticion_destino = 'DPPSGG' and h.codigo_sector_destino = 'MGEYS'
    and h.sector_usuario_origen != 'MGEYS')
)    
